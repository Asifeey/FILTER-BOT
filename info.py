...
auth_channel = environ.get('AUTH_CHANNEL', '-1002525990761') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://electrogggg70:wXyfRcHpIWO0t4lo@cluster0.3bt0yyz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
