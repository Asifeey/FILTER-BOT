...
API_ID = int(environ.get('API_ID', '8118043'))
API_HASH = environ.get('API_HASH', 'd0faa85d88a5307ce9aef4fe996ad739')
BOT_TOKEN = environ.get('BOT_TOKEN', "7910150385:AAES4qYoXJ3nBQdjl9VEwhlp55ZS_WllwiI")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.ibb.co/kVH7kT9t/x.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '846646879').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002299074293'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002634731434', '').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', 'https://t.me/newwwwwwnm') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://electrogggg70:dJQHYBLj7k1KKIsF@hhhhjjj.8vvtbg9.mongodb.net/electrodb?retryWrites=true&w=majority&appName=Hhhhjjj', "")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "electro")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'electro')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/flimfactoryb')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+lxXedRbKQvU4OTg1')
